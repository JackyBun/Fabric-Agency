...
if (isset($_POST['form1'])) {
	...
	mysqli_query($conn, "INSERT INTO supplier_phone VALUES ($sup_ID,$sup_Phone)");
?>
	<script>
					...
					<div class="box box-info">
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="p_supname" class="form-control">
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<input type="text" name="p_bankacc" class="form-control">
								</div>
							</div>
							<div class="form-group">
								<label for="" class="col-sm-3 control-label">Tax Code <span>*</span></label>
								<div class="col-sm-4">
									<input type="text" name="p_taxcode" class="form-control">
								</div>
							</div>
							<div class="form-group">
											...
											<tr>
												<td>
													<div class="upload-btn">
														<input type="text" name="p_phone" style="margin-bottom:5px;">
													</div>
												</td>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								<input type="text" name="p_employeeid" class="form-control">
								</div>
							</div>
							<div class="form-group">
