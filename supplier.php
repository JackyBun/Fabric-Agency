						...
						<table id="example1" class="table table-bordered table-hover table-striped">
							<thead class="thead-dark">
								<tr>
									...
									<th width="100">Bank_Account</th>
									<th width="60">Tax_Code</th>
							...
							<tbody>
								...
								while ($row_supplier = mysqli_fetch_array($supplier)) {
									$sup_ID = $row_supplier['Supplier_Code'];
								?>
									<tr>
										<td>
											<?php
											echo $row_supplier['Supplier_Code'];
											?>
										</td>
										<td>
											<?php
											echo $row_supplier['Sup_Name'];
											?>
										</td>
										<td>
											<?php
											echo $row_supplier['Sup_Address'];
											?>
										</td>
										<td>
											<?php
											echo $row_supplier['Bank_account'];
											?>
										</td>
										<td>
											<?php
											echo $row_supplier['Tax_code'];
											?>
										</td>
										<td>
											<?php
										...
										<td>
											<?php
											$emp_code = $row_supplier['Partner_staff_Code'];
											$emp = mysqli_query($conn, "SELECT * FROM employee WHERE Partner_staff_Code = $emp_code");
											$row_emp = mysqli_fetch_array($emp);
											echo $row_emp['Emp_Fname']." ";
											echo $row_emp['Emp_Lname']
											?>
										</td>
									</tr>
								<?php
