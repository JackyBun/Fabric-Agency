	...
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<a href="index.html" class="logo">
				<span class="logo-lg">eCommerce html</span>
			</a>
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<li class="user-footer">
									<div>
										<a href="profile-edit.html" class="btn btn-default btn-flat">Edit Profile</a>
									</div>
									<div>
										<a href="logout.html" class="btn btn-default btn-flat">Log out</a>
									</div>
								</li>
							</ul>
						</li>
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="lenght.html"><i class="fa fa-circle-o"></i> Length</a></li>
                            <li><a href="color.html"><i class="fa fa-circle-o"></i> Color</a></li>
                            <li><a href="top-category.html"><i class="fa fa-circle-o"></i> Top Level Category</a></li>
                        </ul>
                    </li>
					...
					<li class="treeview">
                        <a href="supplier.html">
                            <i class="fa fa-shopping-bag"></i> <span>Supplier Management</span>
                        </a>
                    </li>
					...
					<li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="pay-now.html"><i class="fa fa-circle-o"></i> Thanh Toán Ngay</a></li>
                            <li><a href="not-now.html"><i class="fa fa-circle-o"></i> Trả sau (Nợ)</a></li>
                        </ul>
                    </li>
              ...
              <div class="box box-info">
                ...
                <div class="box-body table-responsive">
                  <table id="example1" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
							<!-- TRƯỜNG HỢP TRẢ LIỀN (HOẶC TRẢ 1 PHẦN) -->
                            <tr class="">
                                <td>1</td>
                                <td>
                                    <b>Id : 1
